...
router.get(
  "/10-amazing-facts-about-the-magical-northern-lights",
  (req, res) => {
...
router.get(
  "/get-the-most-out-of-italy-by-visiting-these-amazing-places",
  (req, res) => {
    res.render(
      "blog/get-the-most-out-of-italy-by-visiting-these-amazing-places"
    );
  }
);

router.get(
  "/list-of-things-to-do-in-fun-european-cities-of-amsterdam-berlin-prague-budapest",
  (req, res) => {
    res.render(
      "blog/list-of-things-to-do-in-fun-european-cities-of-amsterdam-berlin-prague-budapest"
    );
  }
);

router.get(
  "/most-exotic-and-highly-enjoyable-destinations-to-visit-this-summer",
  (req, res) => {
    res.render(
      "blog/most-exotic-and-highly-enjoyable-destinations-to-visit-this-summer"
    );
  }
);
...
router.get(
  "/travel-tips-to-make-your-first-international-trip-smooth",
  (req, res) => {
...
router.get(
  "/Splendid-Places-to-Visit-in-Vietnam-and-Bring-Out-the-Wanderlust-in-You",
  (req, res) => {
    res.render(
      "blog/Splendid-Places-to-Visit-in-Vietnam-and-Bring-Out-the-Wanderlust-in-You"
    );
  }
);
...
router.get("/budget-friendly-places-to-visit-in-europe", (req, res) => {
  res.render("blog/budget-friendly-places-to-visit-in-europe");
});


router.get("/best-of-indian-culinary-delight", (req, res) => {
  res.render("blog/best-of-indian-culinary-delight");
});

router.get("/how-to-fly-cheap-to-europe-in-2020-by-jetsave-india", (req, res) => {
  res.render("blog/how-to-fly-cheap-to-europe-in-2020-by-jetsave-india");
});
